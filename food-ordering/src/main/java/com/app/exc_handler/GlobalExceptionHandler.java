...
@ControllerAdvice //mandatory : to tell SC following class contains centralized exception handler method/s
...
//How to tell SC : follow. method acts as the exception handling method
